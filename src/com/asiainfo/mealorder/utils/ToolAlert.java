...
import com.asiainfo.mealorder.widget.NotificationMessage;
import com.asiainfo.mealorder.widget.ProgressDialog;
...
public class ToolAlert {
    ...
    public static void toastShort(String msg) {
        Toast.makeText(AppApplication.gainContext(), msg, Toast.LENGTH_SHORT).show();
    }
    ...
    public static void toastLong(String msg) {
        Toast.makeText(AppApplication.gainContext(), msg, Toast.LENGTH_LONG).show();
    }
    ...
    public static void toast(String msg,int duration) {
        Toast.makeText(AppApplication.gainContext(), msg, duration).show();
    }
