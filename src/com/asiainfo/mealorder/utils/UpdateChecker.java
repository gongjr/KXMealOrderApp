...
public class UpdateChecker extends Fragment {
    ...
    private static final String APP_UPDATE_ENTITY = "app_update_entity";
	 ...
	 *            Required.
	 */
	public static void checkForDialog(FragmentActivity fragmentActivity, AppUpdate appUpdate) {
        ...
        args.putSerializable(APP_UPDATE_ENTITY, appUpdate);
	 ...
	 */
	public static void checkForNotification(FragmentActivity fragmentActivity, AppUpdate appUpdate) {
		FragmentTransaction content = fragmentActivity.getSupportFragmentManager().beginTransaction();
		UpdateChecker updateChecker = new UpdateChecker();
		Bundle args = new Bundle();
	...
	public void onAttach(Activity activity) {
        ...
        AppUpdate appUpdate = (AppUpdate)args.getSerializable(APP_UPDATE_ENTITY);
	 ...
	 */
	private void checkForUpdates(final AppUpdate appUpdate) {
		mThread = new Thread() {
			@Override
			public void run() {
				//showNotification(appUpdate.getUpdateMessage(), appUpdate.getUpdateUrl());
				showDialog(appUpdate.getUpdateMessage(), appUpdate.getUpdateUrl());
			}
		};
		mThread.start();
	}
