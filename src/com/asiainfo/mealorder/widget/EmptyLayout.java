...
public class EmptyLayout{
	...
	private String mErrorMessage = "服务器正忙，请稍后重试";
	private String mEmptyMessage = "没有数据哦";
	 ...
	 * @param listView
	 */
	public void setListView(AbsListView absView) {
	...
	private void changeEmptyType() {
		...
		if (!mViewsAdded) {
			...
			ViewGroup parent = (ViewGroup)absView.getParent();
			parent.addView(rl);
			absView.setEmptyView(rl);
		}
	 ...
	 */
	public EmptyLayout(Context context, AbsListView absView) {
		mContext = context;
		mInflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		this.absView = absView;
	}
