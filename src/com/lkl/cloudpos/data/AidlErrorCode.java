...
public class AidlErrorCode {
	...
	public static class Printer {
		/** 设备通讯异常 **/
		public static int ERROR_DEV = 0x00;
		/** 设备未打开 */
		public static int ERROR_DEV_NOT_OPEN = 0x01;
		/** 设备忙 */
		public static int ERROR_DEV_IS_BUSY = 0x02;
		/** 打印位图宽度溢出 */
		public static int ERROR_PRINT_BITMAP_WIDTH_OVERFLOW = 0x03;
		/** 打印位图错误 */
		public static int ERROR_PRINT_BITMAP_OTHER = 0x04;
		/** 缺纸 */
		public static int ERROR_PRINT_NOPAPER = 0x05;
		/** 打印条码错误 */
		public static int ERROR_PRINT_BARCODE_OTHER = 0x06;
		/** 参数错误 */
		public static int ERROR_PRINT_ILLIGALARGUMENT = 0x07;
		/*** 打印文本错误 */
		public static int ERROR_PRINT_TEXT_OTHER = 0x08;
	}
